...
* Based on the description above, what are the attributes of the class GPA?
   -integer sumCredits --> total amount of credits
   -integer sumWeightedPoints --> total number of weighted points


* Based on the description above, what are the methods of the class GPA?
   -default constructor
   -accessor for each attribute
   -method to convert grade to points
   -method to update weighted points
