...
public class GPA
{
 ...
 /**
   * getSumCredits - retrieve the current total amount of credits
   ...
   */ 
   ...
   /**
   * getSumWeightedPoints - retrieve the current total number of weighted points
   ...
   *
   */ 
   public double calcPoints(char letterGrade)
   {
