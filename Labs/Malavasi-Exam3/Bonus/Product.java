...
public class Product
{
   ...
   private String[] info; // array of info for product
   ...
   * Parameterized Constructor
   * @param productPart full product part
   * @param infoSize size of info array
   */
   public Product(String productPart, int infoSize)
   {
      String[] productInfo = productPart.split(":");
      this.productCode = productInfo[0];
      this.assemblyNumber = Integer.parseInt(productInfo[1]);
   ...
   */ 
   ...
   /**
   * retrieves a info item
   * @return the name of the item.
   *
   */ 
   public String getInfoItem(int item)
   {
      return info[item];
   }
   ...
   * @param newInfoItem the new item name.
   *
   */ 
   public void setInfoItem(int item, String newItemName)
   {
       info[item] = newItemName;
   }
   
   /**
   * retrieves info size
   * @return the number of items in info.
   *
   */ 
